...
import prefeitura_rc
import geotecSfundo_rc
import geotec_rc
import maps_rc
import prefeituraRodape_rc
...
"}")
    ...
    def retranslateUi(self, frm_Principal):
        frm_Principal.setWindowTitle(QCoreApplication.translate("frm_Principal", u"MainWindow", None))

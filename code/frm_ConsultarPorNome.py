...
"}")
        ...
        self.btn_consultar.setGeometry(QRect(570, 500, 91, 81))
...
"}")
        ...
        self.btn_pesquisar.setGeometry(QRect(620, 110, 21, 21))
...
"}")
        ...
        self.lbl_nomeCliente.setGeometry(QRect(0, 110, 111, 21))
        font = QFont()
        font.setBold(True)
...
"")
        ...
        self.txt_nomeMorador.setGeometry(QRect(320, 100, 291, 41))
        font1 = QFont()
...
"")
        ...
        self.tableWidget.setGeometry(QRect(0, 160, 661, 331))
...
"}\n"
"")
        self.comboBox = QComboBox(frm_ConsultarPorNome)
        ...
        self.comboBox.setGeometry(QRect(120, 100, 171, 41))
...
"")
    ...
    def retranslateUi(self, frm_ConsultarPorNome):
        ...
        self.lbl_nomeCliente.setText(QCoreApplication.translate("frm_ConsultarPorNome", u"Pesquisar por:", None))
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("frm_ConsultarPorNome", u"Id", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("frm_ConsultarPorNome", u"Coordenadas", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("frm_ConsultarPorNome", u"CoordenadasG", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("frm_ConsultarPorNome", u"Nome", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("frm_ConsultarPorNome", u"Idade", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("frm_ConsultarPorNome", u"G\u00eanero", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("frm_ConsultarPorNome", u"Telefone", None))
        self.comboBox.setItemText(7, QCoreApplication.translate("frm_ConsultarPorNome", u"E-mail", None))
        self.comboBox.setItemText(8, QCoreApplication.translate("frm_ConsultarPorNome", u"Logradouro", None))
        self.comboBox.setItemText(9, QCoreApplication.translate("frm_ConsultarPorNome", u"N\u00famero", None))
        self.comboBox.setItemText(10, QCoreApplication.translate("frm_ConsultarPorNome", u"Complemento", None))
        self.comboBox.setItemText(11, QCoreApplication.translate("frm_ConsultarPorNome", u"Bairro", None))
        self.comboBox.setItemText(12, QCoreApplication.translate("frm_ConsultarPorNome", u"Habitada", None))
        self.comboBox.setItemText(13, QCoreApplication.translate("frm_ConsultarPorNome", u"N\u00famero-Moradores", None))
        self.comboBox.setItemText(14, QCoreApplication.translate("frm_ConsultarPorNome", u"Crian\u00e7as", None))
        self.comboBox.setItemText(15, QCoreApplication.translate("frm_ConsultarPorNome", u"Quantidade-Crian\u00e7as", None))
        self.comboBox.setItemText(16, QCoreApplication.translate("frm_ConsultarPorNome", u"Mobilidade", None))
        self.comboBox.setItemText(17, QCoreApplication.translate("frm_ConsultarPorNome", u"Quantidade", None))
        self.comboBox.setItemText(18, QCoreApplication.translate("frm_ConsultarPorNome", u"Tipo(s)", None))
        self.comboBox.setItemText(19, QCoreApplication.translate("frm_ConsultarPorNome", u"Internet", None))
        self.comboBox.setItemText(20, QCoreApplication.translate("frm_ConsultarPorNome", u"Televis\u00e3o", None))
